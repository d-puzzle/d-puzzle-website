...
Unser Tool befähgt das Team, die enorme Komplexität der Prozesse zu beherrschen.{.take-away}
...
<sup>1</sup> konzeptionell = <em>kohärent und abstrahiert</em>, d.h. durchgängig und zu einem guten Teil unabhängig von der technischen Lösung (wobei wir Menschen mit ihren spezifischen Fähigkeiten auch als Technolgoien betrachten).{.footnote}

<sup>2</sup> Computer-Aided Design, Building Integration Model.{.footnote}

<sup>3</sup> Dies sind meist nicht die Leute, die später die Lösung umsetzen, denn das Soll-Modell dient auch dazu, Umsetzungspartner zu finden und zu beauftragen.{.footnote}
</div>
